...
class HospitalPatient(models.Model):
    ...
    # Ultimas citas
    patient_appointment_ids = fields.One2many("hospital.appointment", inverse_name='patient_id',string="Citas", index = True)
    ...
    def create_appointment(self):
        return {
            ...
            'view_mode': 'form,tree',
            'type': 'ir.actions.act_window',
            'context': {'default_patient_id': self.id, 'default_appointment_date': fields.Datetime.today()}
        }
